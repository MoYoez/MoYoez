...
<html lang="en">
  <head>
    <title>Code coverage report for controllers/category.ts</title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">controllers</a> category.ts
        </h1>
        <div class="clearfix">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { HTTPClient } from '../core/client'
...
&nbsp;
  ...
  async getCategoryDetail(ids: string | string[]): Promise&lt;any&gt; {
    if (typeof ids === 'string') {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!entries) {
<span class="cstat-no" title="statement not covered" >        throw new RequestError(</span>
