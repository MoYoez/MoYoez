...
<html lang="en">
  <head>
    <title>Code coverage report for controllers/aggregate.ts</title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">controllers</a> aggregate.ts
        </h1>
        <div class="clearfix">
...
&nbsp;
  getTimeline(options?: {
    ...
    return this.proxy.timeline.get&lt;{ data: TimelineData }&gt;({
      params: {
        sort: sort &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >sortOrderToNumber(sort),</span>
        type,
        year,
      },
    })
