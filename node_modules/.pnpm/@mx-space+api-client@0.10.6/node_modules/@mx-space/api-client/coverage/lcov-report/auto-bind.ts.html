...
<html lang="en">
  <head>
    <title>Code coverage report for auto-bind.ts</title>
    <meta charset="utf-8" />
  ...
  <body>
    <div class="wrapper">
      <div class="pad1">
        <h1><a href="index.html">All files</a> auto-bind.ts</h1>
        <div class="clearfix">
...
export function autoBind(self, { include, exclude } = {}) {
  const filter = (key) =&gt; {
    const match = <span class="fstat-no" title="function not covered" >(p</span>attern) =&gt;
<span class="cstat-no" title="statement not covered" >      typeof pattern === 'string' ? key === pattern : pattern.test(key)</span>
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (include) {
<span class="cstat-no" title="statement not covered" >      return include.some(match)</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (exclude) {
<span class="cstat-no" title="statement not covered" >      return !exclude.some(match)</span>
    }
&nbsp;
    return true
  }
