    ...
    <div class="wrapper">
      ...
      <div class="pad1">
        <table class="coverage-summary">
          ...
          <tbody>
            <tr>
              <td class="file high" data-value="auto-bind.ts">
                <a href="auto-bind.ts.html">auto-bind.ts</a>
              </td>
              <td data-value="86.36" class="pic high">
                <div class="chart">
                  <div class="cover-fill" style="width: 86%"></div>
                  <div class="cover-empty" style="width: 14%"></div>
                </div>
              </td>
            ...
            <tr>
              <td class="file high" data-value="path.ts">
                <a href="path.ts.html">path.ts</a>
              </td>
