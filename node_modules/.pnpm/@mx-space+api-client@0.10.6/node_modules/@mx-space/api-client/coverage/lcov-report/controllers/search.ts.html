...
<html lang="en">
  <head>
    <title>Code coverage report for controllers/search.ts</title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">controllers</a> search.ts
        </h1>
        <div class="clearfix">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { PageModel } from '..'
