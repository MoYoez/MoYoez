...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { SortOrder } from '~/interfaces/options'
&nbsp;
...
&nbsp;
export const sortOrderToNumber = <span class="fstat-no" title="function not covered" >(o</span>rder: SortOrder) =&gt; {
...
export const destructureData = (payload: any) =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof payload !== 'object') {
<span class="cstat-no" title="statement not covered" >    return payload</span>
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (payload === null) {
<span class="cstat-no" title="statement not covered" >    return payload</span>
  }
&nbsp;
...
export const attachRawFromOneToAnthor = (from: any, to: any) =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!from || !isObject(to)) {
<span class="cstat-no" title="statement not covered" >    return</span>
  }
  from.$raw &amp;&amp;
  ...
  from.$request &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >    Object.defineProperty(to, '$request', {</span>
      value: { ...from.$request },
      enumerable: false,
    })
}
