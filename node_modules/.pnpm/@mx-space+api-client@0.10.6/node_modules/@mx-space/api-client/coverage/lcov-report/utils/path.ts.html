...
<html lang="en">
  <head>
    <title>Code coverage report for utils/path.ts</title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">utils</a> path.ts
        </h1>
        <div class="clearfix">
...
<span class="cline-any cline-yes">80x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export const resolveFullPath = (endpoint: string, path: string) =&gt; {
  if (!path.startsWith('/')) {
    path = `/${path}`
  }
