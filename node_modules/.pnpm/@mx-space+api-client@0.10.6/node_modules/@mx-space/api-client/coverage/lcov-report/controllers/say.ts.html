...
<html lang="en">
  <head>
    <title>Code coverage report for controllers/say.ts</title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">controllers</a> say.ts
        </h1>
        <div class="clearfix">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { HTTPClient } from '../core'
...
&nbsp;
   ...
   * 获取随机一条
   */
<span class="fstat-no" title="function not covered" >  getRandom(</span>) {
<span class="cstat-no" title="statement not covered" >    return this.proxy.random.get&lt;{ data: SayModel | null }&gt;()</span>
  }
}
&nbsp;</pre></td></tr></table></pre>
