...
<html lang="en">
  <head>
    <title>Code coverage report for core/attach-request.ts</title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">core</a> attach-request.ts
        </h1>
        <div class="clearfix">
...
<span class="cline-any cline-yes">72x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import type { HTTPClient } from '.'
&nbsp;
...
function handleSearchParams(obj: URLSearchParams | Record&lt;string, string&gt;) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!obj &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof obj !== 'object')</span> {
<span class="cstat-no" title="statement not covered" >    throw new TypeError('params must be object.')</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (obj instanceof URLSearchParams) {
