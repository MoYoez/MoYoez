...
<html lang="en">
  <head>
    <title>Code coverage report for core/client.ts</title>
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
      <div class="pad1">
        <h1>
          ...
          <a href="index.html">core</a> client.ts
        </h1>
        <div class="clearfix">
...
<a name='L234'></a><a href='#L234'>234</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">16x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import camelcaseKeys from 'camelcase-keys'
...
&nbsp;
  public request(options: {
    ...
    return (this as any)[`$$${String(options.method || <span class="branch-1 cbranch-no" title="branch not covered" >'get')</span>.toLowerCase()}`](
      options.url,
      options,
          ...
          if (reflectors.includes(name))
            return (withBase?: boolean) =&gt; {
              if (withBase) {
                ...
                route.length = 0
                return path.startsWith('/') ? path : <span class="branch-1 cbranch-no" title="branch not covered" >`/${path}`</span>
              }
            }
              ...
              try {
                ...
                throw new RequestError(
                  ...
                  e.code ||
                    ...
                    e.statusCode ||
                    e.response?.status ||
<span class="branch-4 cbranch-no" title="branch not covered" >                    e.response?.statusCode </span>||
<span class="branch-5 cbranch-no" title="branch not covered" >                    e.response?.code </span>||
<span class="branch-6 cbranch-no" title="branch not covered" >                    500,</span>
                  url,
                  e,
                )
              }
