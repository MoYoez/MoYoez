...
<ul><li><a href=https://github.com/vikingmute/better-wechatpay>vikingmute/better-wechatpay</a><p>现代化的微信支付 Node.js SDK - ESM、TypeScript、全支付方式支持</p></li><li><a href=https://github.com/seemoo-lab/owl>seemoo-lab/owl</a><p>An open Apple Wireless Direct Link (AWDL) implementation written in C</p></li><li><a href=https://github.com/obra/superpowers>obra/superpowers</a><p>An agentic skills framework & software development methodology that works.</p></li><li><a href=https://github.com/mattpocock/skills>mattpocock/skills</a><p>Skills for Real Engineers. Straight from my .claude directory.</p></li><li><a href=https://github.com/crewAIInc/crewAI>crewAIInc/crewAI</a><p>Framework for orchestrating role-playing, autonomous AI agents. By fostering collaborative intelligence, CrewAI empowers agents to work together seamlessly, tackling complex tasks.</p></li></ul>

**Starred**

<ul><li><a href=https://github.com/CherryHQ/cherry-studio>CherryHQ/cherry-studio</a><p>AI productivity studio with smart chat, autonomous agents, and 300+ assistants. Unified access to frontier LLMs</p></li><li><a href=https://github.com/t8y2/dbx>t8y2/dbx</a><p>15MB, lightweight, cross-platform database client. Supports MySQL, PostgreSQL, SQLite, Redis, MongoDB, DuckDB, ClickHouse, SQL Server and more.15MB，轻量级跨平台数据库客户端。支持 MySQL、PostgreSQL、SQLite、Redis、MongoDB、DuckDB、ClickHouse、SQL Server 等。</p></li><li><a href=https://github.com/NeteaseCloudMusicApiEnhanced/api-enhanced>NeteaseCloudMusicApiEnhanced/api-enhanced</a><p>🔍 全网最全的网易云音乐API接口 || A revival project for NeteaseCloudMusicApi Node.js Services (Half Refactor & Enhanced) || 网易云音乐 API 备份 + 增强 || 本项目自原版v4.28.0版本后开始自行维护</p></li><li><a href=https://github.com/JuliusBrussee/caveman>JuliusBrussee/caveman</a><p>🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking like caveman</p></li><li><a href=https://github.com/memohai/Autofish>memohai/Autofish</a><p>An AI Agent tool to automate Android devices reliably</p></li></ul>

------------

<p align=center><strong> Stay hungry, Stay foolish. </strong></p>
<p align=center>此文件 <i>README</i> <b>间隔 24 小时</b>自动刷新生成！ <b>设计参考为 <a href=https://github.com/wibus-wee>Wibus</a> 和 <a href=https://github.com/MoeCinnamo>MoeCinnamo</a> , Thanks.</b><br>刷新于：5/19/26, 8:29 AM<br>下一次刷新：5/20/26, 8:29 AM</p>
