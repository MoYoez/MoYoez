...
<ul><li><a href=https://github.com/unclemcz/ban-pcdn-ip>unclemcz/ban-pcdn-ip</a><p>收集恶意刷取网站CDN流量的PCDN IP段清单。</p></li><li><a href=https://github.com/nekomeowww/talks>nekomeowww/talks</a><p>💬🗣️ Public talks I presented historically in Demo Day, Demo Inn, KubeCon, @DaoCloud, all built with @slidevjs</p></li><li><a href=https://github.com/lit/lit>lit/lit</a><p>Lit is a simple library for building fast, lightweight web components.</p></li><li><a href=https://github.com/umami-software/umami>umami-software/umami</a><p>Umami is a modern, privacy-focused alternative to Google Analytics.</p></li><li><a href=https://github.com/Petterpx/FloatingX>Petterpx/FloatingX</a><p>Android上强大的悬浮窗组件，支持 系统浮窗(需要权限)、应用内浮窗(无权限)、局部悬浮(View)，支持边缘吸附、回弹、自定义动画、位置保存、窗口化及分屏后位置修复等。Android without permission suspension window(App), support global(View), local suspension, support edge adsorption, rebound, custom animation, position saving, windowing and split-screen position repair.</p></li></ul>

**Starred**

<ul><li><a href=https://github.com/kleampa/not-paid>kleampa/not-paid</a><p>Client did not pay? Add opacity to the body tag and decrease it every day until their site completely fades away</p></li><li><a href=https://github.com/iawia002/lux>iawia002/lux</a><p>👾 Fast and simple video download library and CLI tool written in Go</p></li><li><a href=https://github.com/proj-airi/awesome-ai-vtuber>proj-airi/awesome-ai-vtuber</a><p>🧾🧸 A curated list of AI VTubers and their related projects</p></li><li><a href=https://github.com/iyear/tdl>iyear/tdl</a><p>📥 A Telegram toolkit written in Golang</p></li><li><a href=https://github.com/latexstudio-org/mcmthesis>latexstudio-org/mcmthesis</a><p>LaTeX2e Template designed for MCM/ICM</p></li></ul>

------------

<p align=center><strong> Stay hungry, Stay foolish. </strong></p>
<p align=center>此文件 <i>README</i> <b>间隔 24 小时</b>自动刷新生成！ <b>设计参考为 <a href=https://github.com/wibus-wee>Wibus</a> 和 <a href=https://github.com/MoeCinnamo>MoeCinnamo</a> , Thanks.</b><br>刷新于：6/13/25, 8:02 AM<br>下一次刷新：6/14/25, 8:02 AM</p>
