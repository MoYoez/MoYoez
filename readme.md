...
<ul><li><a href=https://github.com/nekomeowww/talks>nekomeowww/talks</a><p>💬🗣️ Public talks I presented historically in Demo Day, Demo Inn, KubeCon, @DaoCloud, all built with @slidevjs</p></li><li><a href=https://github.com/lit/lit>lit/lit</a><p>Lit is a simple library for building fast, lightweight web components.</p></li><li><a href=https://github.com/SaltifyDev/adapter-lagrange>SaltifyDev/adapter-lagrange</a><p>Power Saltify with NTQQ engine written in Kotlin</p></li><li><a href=https://github.com/umami-software/umami>umami-software/umami</a><p>Umami is a modern, privacy-focused alternative to Google Analytics.</p></li><li><a href=https://github.com/Petterpx/FloatingX>Petterpx/FloatingX</a><p>Android上强大的悬浮窗组件，支持 系统浮窗(需要权限)、应用内浮窗(无权限)、局部悬浮(View)，支持边缘吸附、回弹、自定义动画、位置保存、窗口化及分屏后位置修复等。Android without permission suspension window(App), support global(View), local suspension, support edge adsorption, rebound, custom animation, position saving, windowing and split-screen position repair.</p></li></ul>

**Starred**

<ul><li><a href=https://github.com/ling-drag0n/CloudPaste>ling-drag0n/CloudPaste</a><p>基于Cloudflare的在线文本/大文件分享平台，支持多种语法 Markdown 渲染、阅后即焚、S3聚合存储、密码保护等功能，可作为WebDav挂载，支持Docker部署。</p></li><li><a href=https://github.com/moeru-ai/airi>moeru-ai/airi</a><p>💖🧸 A container of souls of AI waifu / virtual characters to bring them into our worlds, wishing to achieve Neuro-sama's altitude, completely LLM and AI driven, capable of realtime voice chat, Minecraft playing, Factorio playing. Can be run in Browser or Desktop.</p></li><li><a href=https://github.com/latexstudio-org/mcmthesis>latexstudio-org/mcmthesis</a><p>LaTeX2e Template designed for MCM/ICM</p></li><li><a href=https://github.com/kleampa/not-paid>kleampa/not-paid</a><p>Client did not pay? Add opacity to the body tag and decrease it every day until their site completely fades away</p></li><li><a href=https://github.com/groupultra/telegram-search>groupultra/telegram-search</a><p>🔍 一个功能强大的 Telegram 聊天记录搜索工具，支持向量搜索和语义匹配。A powerful Telegram chat search tool with vector search and semantic matching capabilities.</p></li></ul>

------------

<p align=center><strong> Stay hungry, Stay foolish. </strong></p>
<p align=center>此文件 <i>README</i> <b>间隔 24 小时</b>自动刷新生成！ <b>设计参考为 <a href=https://github.com/wibus-wee>Wibus</a> 和 <a href=https://github.com/MoeCinnamo>MoeCinnamo</a> , Thanks.</b><br>刷新于：6/5/25, 8:02 AM<br>下一次刷新：6/6/25, 8:02 AM</p>
