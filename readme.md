...
<ul><li><a href=https://github.com/vitejs/devtools>vitejs/devtools</a><p>DevTools for Vite (Rolldown). Working in Progress</p></li><li><a href=https://github.com/proj-airi/chromatic>proj-airi/chromatic</a><p>🎨 Readability enhanced, clean, nice looking colors palette we used across our Project AIRI projects!</p></li><li><a href=https://github.com/wenlng/go-captcha>wenlng/go-captcha</a><p>🖖 GoCaptcha is a behavior captcha, which implements click mode, slider mode, drag-drop mode and rotation mode.</p></li><li><a href=https://github.com/aemkei/jsfuck>aemkei/jsfuck</a><p>Write any JavaScript with 6 Characters: []()!+</p></li><li><a href=https://github.com/Deepractice/PromptX>Deepractice/PromptX</a><p>PromptX · 领先的AI上下文工程平台 ｜ PromptX · The Leading AI Context Engineering Platform</p></li></ul>

**Starred**

<ul><li><a href=https://github.com/moeru-ai/airi>moeru-ai/airi</a><p>💖🧸 A container of souls of AI waifu / virtual characters to bring them into our worlds, wishing to achieve Neuro-sama's altitude, completely LLM and AI driven, capable of realtime voice chat, Minecraft playing, Factorio playing. Can be run in Browser or Desktop.</p></li><li><a href=https://github.com/PatrickJS/awesome-cursorrules>PatrickJS/awesome-cursorrules</a><p>📄 Configuration files that enhance Cursor AI editor experience with custom rules and behaviors</p></li><li><a href=https://github.com/iverycd/gomysql2pg>iverycd/gomysql2pg</a><p>mysql to pg mysql2pg - A tool using GoLang migrating database from MySQL to PostgreSQL,MySQL sync to pgsql,MySQL mig pgsql</p></li><li><a href=https://github.com/cline/cline>cline/cline</a><p>Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.</p></li><li><a href=https://github.com/latexstudio-org/mcmthesis>latexstudio-org/mcmthesis</a><p>LaTeX2e Template designed for MCM/ICM</p></li></ul>

------------

<p align=center><strong> Stay hungry, Stay foolish. </strong></p>
<p align=center>此文件 <i>README</i> <b>间隔 24 小时</b>自动刷新生成！ <b>设计参考为 <a href=https://github.com/wibus-wee>Wibus</a> 和 <a href=https://github.com/MoeCinnamo>MoeCinnamo</a> , Thanks.</b><br>刷新于：7/15/25, 8:02 AM<br>下一次刷新：7/16/25, 8:02 AM</p>
