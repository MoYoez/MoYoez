...
<ul><li><a href=https://github.com/pilcrowonpaper/arctic>pilcrowonpaper/arctic</a><p>OAuth 2.0 clients for popular providers</p></li><li><a href=https://github.com/skyventuree/p5cc>skyventuree/p5cc</a><p>For the sake of effortlessly making a calling card. Sending your card to the darkest desire.</p></li><li><a href=https://github.com/lucia-auth/lucia>lucia-auth/lucia</a><p>Authentication, simple and clean</p></li><li><a href=https://github.com/vitejs/devtools>vitejs/devtools</a><p>DevTools for Vite (Rolldown). Working in Progress</p></li><li><a href=https://github.com/proj-airi/chromatic>proj-airi/chromatic</a><p>🎨 Readability enhanced, clean, nice looking colors palette we used across our Project AIRI projects!</p></li></ul>

**Starred**

<ul><li><a href=https://github.com/Petterpx/FloatingX>Petterpx/FloatingX</a><p>Android上强大的悬浮窗组件，支持 系统浮窗(需要权限)、应用内浮窗(无权限)、局部悬浮(View)，支持边缘吸附、回弹、自定义动画、位置保存、窗口化及分屏后位置修复等。Android without permission suspension window(App), support global(View), local suspension, support edge adsorption, rebound, custom animation, position saving, windowing and split-screen position repair.</p></li><li><a href=https://github.com/lit/lit>lit/lit</a><p>Lit is a simple library for building fast, lightweight web components.</p></li><li><a href=https://github.com/proj-airi/awesome-ai-vtubers>proj-airi/awesome-ai-vtubers</a><p>🧾🧸 A curated list of AI VTubers and their related projects</p></li><li><a href=https://github.com/latexstudio-org/mcmthesis>latexstudio-org/mcmthesis</a><p>LaTeX2e Template designed for MCM/ICM</p></li><li><a href=https://github.com/cline/cline>cline/cline</a><p>Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.</p></li></ul>

------------

<p align=center><strong> Stay hungry, Stay foolish. </strong></p>
<p align=center>此文件 <i>README</i> <b>间隔 24 小时</b>自动刷新生成！ <b>设计参考为 <a href=https://github.com/wibus-wee>Wibus</a> 和 <a href=https://github.com/MoeCinnamo>MoeCinnamo</a> , Thanks.</b><br>刷新于：8/5/25, 8:03 AM<br>下一次刷新：8/6/25, 8:03 AM</p>
