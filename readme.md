...
<ul><li><a href=https://github.com/aemkei/jsfuck>aemkei/jsfuck</a><p>Write any JavaScript with 6 Characters: []()!+</p></li><li><a href=https://github.com/Deepractice/PromptX>Deepractice/PromptX</a><p>PromptX · AI应用原生专业能力增强系统 通过MCP协议为AI应用提供专业角色、记忆管理和知识体系，一行命令，让任何 AI 客户端秒变专业选手。</p></li><li><a href=https://github.com/cline/cline>cline/cline</a><p>Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.</p></li><li><a href=https://github.com/unclemcz/ban-pcdn-ip>unclemcz/ban-pcdn-ip</a><p>收集恶意刷取网站CDN流量的PCDN IP段清单。</p></li><li><a href=https://github.com/nekomeowww/talks>nekomeowww/talks</a><p>💬🗣️ Public talks I presented historically in Demo Day, Demo Inn, KubeCon, @DaoCloud, all built with @slidevjs</p></li></ul>

**Starred**

<ul><li><a href=https://github.com/moeru-ai/airi>moeru-ai/airi</a><p>💖🧸 A container of souls of AI waifu / virtual characters to bring them into our worlds, wishing to achieve Neuro-sama's altitude, completely LLM and AI driven, capable of realtime voice chat, Minecraft playing, Factorio playing. Can be run in Browser or Desktop.</p></li><li><a href=https://github.com/proj-airi/awesome-ai-vtuber>proj-airi/awesome-ai-vtuber</a><p>🧾🧸 A curated list of AI VTubers and their related projects</p></li><li><a href=https://github.com/ling-drag0n/CloudPaste>ling-drag0n/CloudPaste</a><p>基于Cloudflare的在线文本/大文件分享平台，支持多种语法 Markdown 渲染、阅后即焚、S3聚合存储、密码保护等功能，可作为WebDav挂载，支持Docker部署。</p></li><li><a href=https://github.com/Petterpx/FloatingX>Petterpx/FloatingX</a><p>Android上强大的悬浮窗组件，支持 系统浮窗(需要权限)、应用内浮窗(无权限)、局部悬浮(View)，支持边缘吸附、回弹、自定义动画、位置保存、窗口化及分屏后位置修复等。Android without permission suspension window(App), support global(View), local suspension, support edge adsorption, rebound, custom animation, position saving, windowing and split-screen position repair.</p></li><li><a href=https://github.com/perkfly/reverse-interview-zh>perkfly/reverse-interview-zh</a><p>技术面试最后反问面试官的话</p></li></ul>

------------

<p align=center><strong> Stay hungry, Stay foolish. </strong></p>
<p align=center>此文件 <i>README</i> <b>间隔 24 小时</b>自动刷新生成！ <b>设计参考为 <a href=https://github.com/wibus-wee>Wibus</a> 和 <a href=https://github.com/MoeCinnamo>MoeCinnamo</a> , Thanks.</b><br>刷新于：6/17/25, 8:02 AM<br>下一次刷新：6/18/25, 8:02 AM</p>
